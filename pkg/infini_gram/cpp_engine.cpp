...
PYBIND11_MODULE(cpp_engine, m) {
    ...
    py::class_<Engine<U8>>(m, "Engine_U8")
        ...
        .def("prob_batched", &Engine<U8>::prob_batched, py::call_guard<py::gil_scoped_release>(), "prompt_ids_batch"_a, "cont_ids"_a)
        .def("prob_sequence", &Engine<U8>::prob_sequence, py::call_guard<py::gil_scoped_release>(), "input_ids"_a)
        .def("prob_batched_sequence", &Engine<U8>::prob_batched_sequence, py::call_guard<py::gil_scoped_release>(), "input_ids_batch"_a)
        .def("ntd", &Engine<U8>::ntd, py::call_guard<py::gil_scoped_release>(), "prompt_ids"_a, "max_support"_a)
        .def("ntd_sequence", &Engine<U8>::ntd_sequence, py::call_guard<py::gil_scoped_release>(), "input_ids"_a, "max_support"_a)
        .def("ntd_batched_sequence", &Engine<U8>::ntd_batched_sequence, py::call_guard<py::gil_scoped_release>(), "input_ids_batch"_a, "max_support"_a)
        .def("infgram_prob", &Engine<U8>::infgram_prob, py::call_guard<py::gil_scoped_release>(), "prompt_ids"_a, "cont_id"_a)
        .def("infgram_prob_batched", &Engine<U8>::infgram_prob_batched, py::call_guard<py::gil_scoped_release>(), "prompt_ids_batch"_a, "cont_ids"_a)
        .def("infgram_prob_sequence", &Engine<U8>::infgram_prob_sequence, py::call_guard<py::gil_scoped_release>(), "input_ids"_a)
        .def("infgram_prob_batched_sequence", &Engine<U8>::infgram_prob_batched_sequence, py::call_guard<py::gil_scoped_release>(), "input_ids_batch"_a)
        .def("infgram_ntd", &Engine<U8>::infgram_ntd, py::call_guard<py::gil_scoped_release>(), "prompt_ids"_a, "max_support"_a)
        .def("infgram_ntd_sequence", &Engine<U8>::infgram_ntd_sequence, py::call_guard<py::gil_scoped_release>(), "input_ids"_a, "max_support"_a)
        .def("infgram_ntd_batched_sequence", &Engine<U8>::infgram_ntd_batched_sequence, py::call_guard<py::gil_scoped_release>(), "input_ids_batch"_a, "max_support"_a)
    ...
    py::class_<Engine<U16>>(m, "Engine_U16")
        ...
        .def("prob_batched", &Engine<U16>::prob_batched, py::call_guard<py::gil_scoped_release>(), "prompt_ids_batch"_a, "cont_ids"_a)
        .def("prob_sequence", &Engine<U16>::prob_sequence, py::call_guard<py::gil_scoped_release>(), "input_ids"_a)
        .def("prob_batched_sequence", &Engine<U16>::prob_batched_sequence, py::call_guard<py::gil_scoped_release>(), "input_ids_batch"_a)
        .def("ntd", &Engine<U16>::ntd, py::call_guard<py::gil_scoped_release>(), "prompt_ids"_a, "max_support"_a)
        .def("ntd_sequence", &Engine<U16>::ntd_sequence, py::call_guard<py::gil_scoped_release>(), "input_ids"_a, "max_support"_a)
        .def("ntd_batched_sequence", &Engine<U16>::ntd_batched_sequence, py::call_guard<py::gil_scoped_release>(), "input_ids_batch"_a, "max_support"_a)
        .def("infgram_prob", &Engine<U16>::infgram_prob, py::call_guard<py::gil_scoped_release>(), "prompt_ids"_a, "cont_id"_a)
        .def("infgram_prob_batched", &Engine<U16>::infgram_prob_batched, py::call_guard<py::gil_scoped_release>(), "prompt_ids_batch"_a, "cont_ids"_a)
        .def("infgram_prob_sequence", &Engine<U16>::infgram_prob_sequence, py::call_guard<py::gil_scoped_release>(), "input_ids"_a)
        .def("infgram_prob_batched_sequence", &Engine<U16>::infgram_prob_batched_sequence, py::call_guard<py::gil_scoped_release>(), "input_ids_batch"_a)
        .def("infgram_ntd", &Engine<U16>::infgram_ntd, py::call_guard<py::gil_scoped_release>(), "prompt_ids"_a, "max_support"_a)
        .def("infgram_ntd_sequence", &Engine<U16>::infgram_ntd_sequence, py::call_guard<py::gil_scoped_release>(), "input_ids"_a, "max_support"_a)
        .def("infgram_ntd_batched_sequence", &Engine<U16>::infgram_ntd_batched_sequence, py::call_guard<py::gil_scoped_release>(), "input_ids_batch"_a, "max_support"_a)
    ...
    py::class_<Engine<U32>>(m, "Engine_U32")
        ...
        .def("prob_batched", &Engine<U32>::prob_batched, py::call_guard<py::gil_scoped_release>(), "prompt_ids_batch"_a, "cont_ids"_a)
        .def("prob_sequence", &Engine<U32>::prob_sequence, py::call_guard<py::gil_scoped_release>(), "input_ids"_a)
        .def("prob_batched_sequence", &Engine<U32>::prob_batched_sequence, py::call_guard<py::gil_scoped_release>(), "input_ids_batch"_a)
        .def("ntd", &Engine<U32>::ntd, py::call_guard<py::gil_scoped_release>(), "prompt_ids"_a, "max_support"_a)
        .def("ntd_sequence", &Engine<U32>::ntd_sequence, py::call_guard<py::gil_scoped_release>(), "input_ids"_a, "max_support"_a)
        .def("ntd_batched_sequence", &Engine<U32>::ntd_batched_sequence, py::call_guard<py::gil_scoped_release>(), "input_ids_batch"_a, "max_support"_a)
        .def("infgram_prob", &Engine<U32>::infgram_prob, py::call_guard<py::gil_scoped_release>(), "prompt_ids"_a, "cont_id"_a)
        .def("infgram_prob_batched", &Engine<U32>::infgram_prob_batched, py::call_guard<py::gil_scoped_release>(), "prompt_ids_batch"_a, "cont_ids"_a)
        .def("infgram_prob_sequence", &Engine<U32>::infgram_prob_sequence, py::call_guard<py::gil_scoped_release>(), "input_ids"_a)
        .def("infgram_prob_batched_sequence", &Engine<U32>::infgram_prob_batched_sequence, py::call_guard<py::gil_scoped_release>(), "input_ids_batch"_a)
        .def("infgram_ntd", &Engine<U32>::infgram_ntd, py::call_guard<py::gil_scoped_release>(), "prompt_ids"_a, "max_support"_a)
        .def("infgram_ntd_sequence", &Engine<U32>::infgram_ntd_sequence, py::call_guard<py::gil_scoped_release>(), "input_ids"_a, "max_support"_a)
        .def("infgram_ntd_batched_sequence", &Engine<U32>::infgram_ntd_batched_sequence, py::call_guard<py::gil_scoped_release>(), "input_ids_batch"_a, "max_support"_a)
